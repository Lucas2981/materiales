"""
Django settings for material_crud project.
...
#"django-insecure-_u3-si0yj(*3*a=^*c+bcvvu+fv9_8m#-q+^+7sihtk^ult&op"
...
ROOT_URLCONF = "material_crud.urls"
...
WSGI_APPLICATION = "material_crud.wsgi.application"
